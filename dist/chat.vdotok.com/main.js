...
class HttpService {
  constructor(router, svc) {
    this.router = router;
    this.svc = svc;
    this.baseUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_1__.environment.apiBaseUrl + _environments_environment__WEBPACK_IMPORTED_MODULE_1__.environment.version;
  }
  intercept(req, next) {
